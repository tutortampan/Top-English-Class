    ...
    import { fetchStudentClasses, fetchStudentProgress, fetchAssessmentsForStudentClass, fetchStudentAttemptsForAssessment, fetchAllStudentAttempts, updateStudentPin, uploadStudentPhoto, updateStudentGender, updateStudentBirthday, updateStudentEducation, formatStudentName, fetchAssignments, fetchAssessments } from './js/api.js?v=4.7.0';
    import { requireStudentSession, clearStudentSession, updateStudentSessionGender } from './js/session.js?v=4.7.0';
    import { showToast, showLoading, hideLoading, getGrade, withTimeout } from './js/app.js?v=4.7.0';
    import { testMicrophoneCapability } from './js/speech.js?v=4.7.0';
      ...
      try {
        ...
        if (st && st.education) {
          ...
          if (hasEducation && !session.education) {
             ...
             const { setStudentSession } = await import('./js/session.js?v=4.7.0');
